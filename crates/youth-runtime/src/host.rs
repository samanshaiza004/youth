...
pub struct TurnReceipt {
    ...
    pub external_effect_writes: u32,
...
pub(crate) struct HostState {
    ...
    staged_save: Option<crate::text_document::SaveJob>,
    committed_save: Option<crate::text_document::SaveJob>,
    text_document_calls: u32,
    external_effect_writes: u32,
...
impl HostState {
    ...
    fn discard_staged_save(&mut self) {
        self.staged_save = None;
    }

    fn commit_staged_save(&mut self) -> Result<(), crate::TextDocumentError> {
        let Some(job) = self.staged_save.take() else {
            return Ok(());
        };
        let document = self
            .text_document
            .as_ref()
            .ok_or(crate::TextDocumentError::InvalidPath)?;
        document.mark_pending(job.request)?;
        self.committed_save = Some(job);
        Ok(())
    }
}
...
impl crate::bindings::v007::youth::app::ui::Host for HostState {}

impl crate::bindings::v007::youth::state::store::Host for HostState {
    fn get(
        &mut self,
        key: String,
    ) -> Result<
        Option<crate::bindings::v007::youth::state::store::Value>,
        crate::bindings::v007::youth::state::store::StateError,
    > {
        self.state
            .get(&key)
            .map(|value| value.map(to_wire_state_value_v007))
            .map_err(to_wire_state_error_v007)
    }

    fn set(
        &mut self,
        key: String,
        value: crate::bindings::v007::youth::state::store::Value,
    ) -> Result<(), crate::bindings::v007::youth::state::store::StateError> {
        self.state
            .set(&key, from_wire_state_value_v007(value))
            .map_err(to_wire_state_error_v007)
    }
    ...
    fn delete(
        &mut self,
        key: String,
    ) -> Result<bool, crate::bindings::v007::youth::state::store::StateError> {
        self.state.delete(&key).map_err(to_wire_state_error_v007)
    }
}

fn to_wire_state_value_v007(
    value: youth_state::StateValue,
) -> crate::bindings::v007::youth::state::store::Value {
    use crate::bindings::v007::youth::state::store::Value;
    match value {
        youth_state::StateValue::Boolean(value) => Value::Boolean(value),
        youth_state::StateValue::Integer(value) => Value::Integer(value),
        youth_state::StateValue::Text(value) => Value::Text(value),
...
fn to_wire_state_error_v007(
    error: youth_state::StateError,
) -> crate::bindings::v007::youth::state::store::StateError {
    use crate::bindings::v007::youth::state::store::ErrorCode;
    let code = match error {
        youth_state::StateError::InvalidKey => ErrorCode::InvalidKey,
        youth_state::StateError::InvalidValue => ErrorCode::InvalidValue,
        youth_state::StateError::ReadOnly => ErrorCode::ReadOnly,
...
impl crate::bindings::v007::youth::editor::session::Host for HostState {
    fn snapshot(
        &mut self,
        editor: u64,
    ) -> Result<
        crate::bindings::v007::youth::editor::session::EditorSnapshot,
        crate::bindings::v007::youth::editor::session::EditorErrorCode,
    > {
        let editor = editor_node_id_v007(editor)?;
        crate::editor_session::snapshot_editor_session(self.editor_sessions_for_call_mut(), editor)
            .map(to_wire_editor_snapshot_v007)
            .map_err(to_wire_editor_error_v007)
    }
    ...
    fn accept(
        ...
        expected_edit_sequence: u64,
        new_document_revision: u64,
    ) -> Result<(), crate::bindings::v007::youth::editor::session::EditorErrorCode> {
        let editor = editor_node_id_v007(editor)?;
        crate::editor_session::accept_editor_session(
            self.staged_editor_sessions_mut(),
            editor,
...
fn editor_node_id_v007(
    value: u64,
) -> Result<youth_tree::NodeId, crate::bindings::v007::youth::editor::session::EditorErrorCode> {
    youth_tree::NodeId::new(value)
        .ok_or(crate::bindings::v007::youth::editor::session::EditorErrorCode::UnknownEditor)
}

fn to_wire_editor_snapshot_v007(
    snapshot: crate::editor_session::EditorSnapshot,
) -> crate::bindings::v007::youth::editor::session::EditorSnapshot {
    crate::bindings::v007::youth::editor::session::EditorSnapshot {
        document_revision: snapshot.document_revision,
...
fn to_wire_editor_error_v007(
    error: crate::editor_session::EditorSessionError,
) -> crate::bindings::v007::youth::editor::session::EditorErrorCode {
    use crate::bindings::v007::youth::editor::session::EditorErrorCode;
    match error {
        crate::editor_session::EditorSessionError::UnknownEditor => EditorErrorCode::UnknownEditor,
        crate::editor_session::EditorSessionError::StaleDocumentRevision => {
            EditorErrorCode::StaleDocumentRevision
...
impl crate::bindings::v007::youth::time::scheduler::Host for HostState {
    fn schedule_after(
        &mut self,
        millis: u64,
        options: crate::bindings::v007::youth::time::scheduler::ScheduleOptions,
    ) -> Result<
        crate::bindings::v007::youth::time::scheduler::Schedule,
        crate::bindings::v007::youth::time::scheduler::ScheduleErrorCode,
    > {
        let now_epoch_millis = self.deadline_clock.now_epoch_millis();
        let notification = options
            .notification
        ...
        let record = self
            .state
            .schedule_create(now_epoch_millis, millis, notification)
            .map_err(to_wire_schedule_error_v007)?;
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Create {
                app_id: self.state.app_id().clone(),
                record: record.clone(),
        ...
        Ok(to_wire_schedule_v007(&record))
    }

    fn pause(
        &mut self,
        value: crate::bindings::v007::youth::time::scheduler::Schedule,
    ) -> Result<
        crate::bindings::v007::youth::time::scheduler::Schedule,
        crate::bindings::v007::youth::time::scheduler::ScheduleErrorCode,
    > {
        ...
        let previous = self
            ...
            .map_err(to_wire_schedule_error_v007)?
            .ok_or(
                crate::bindings::v007::youth::time::scheduler::ScheduleErrorCode::UnknownSchedule,
            )?;
        let paused = self
            .state
            .schedule_pause(now_epoch_millis, value.id, value.generation)
            .map_err(to_wire_schedule_error_v007)?;
        let wire_paused = to_wire_schedule_v007(&paused);
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Pause {
                app_id: self.state.app_id().clone(),
                previous,
    ...
    > {
        ...
        let resumed = self
            ...
            .schedule_resume(now_epoch_millis, value.id, value.generation)
            .map_err(to_wire_schedule_error_v007)?;
        let wire_resumed = to_wire_schedule_v007(&resumed);
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Resume {
                app_id: self.state.app_id().clone(),
                previous,
    ...
    fn cancel(
        &mut self,
        value: crate::bindings::v007::youth::time::scheduler::Schedule,
    ) -> Result<(), crate::bindings::v007::youth::time::scheduler::ScheduleErrorCode> {
        let previous = self
            .state
            .schedule(value.id)
            .map_err(to_wire_schedule_error_v007)?
        ...
        let cancelled = self
            ...
            .schedule(value.id)
            .map_err(to_wire_schedule_error_v007)?
            .ok_or(crate::bindings::v007::youth::time::scheduler::ScheduleErrorCode::Internal)?;
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Cancel {
                app_id: self.state.app_id().clone(),
                previous,
...
fn to_wire_schedule_error_v007(
    error: youth_state::StateError,
) -> crate::bindings::v007::youth::time::scheduler::ScheduleErrorCode {
    use crate::bindings::v007::youth::time::scheduler::ScheduleErrorCode;
    match error {
        youth_state::StateError::InvalidScheduleDuration => ScheduleErrorCode::InvalidDuration,
        youth_state::StateError::TooManySchedules => ScheduleErrorCode::TooManySchedules,
        youth_state::StateError::UnknownSchedule => ScheduleErrorCode::UnknownSchedule,
...
impl crate::bindings::v008::youth::app::ui::Host for HostState {}

impl crate::bindings::v008::youth::state::store::Host for HostState {
    fn get(
        &mut self,
        key: String,
    ) -> Result<
        Option<crate::bindings::v008::youth::state::store::Value>,
        crate::bindings::v008::youth::state::store::StateError,
    > {
        self.state
            .get(&key)
            .map(|value| value.map(to_wire_state_value_v008))
            .map_err(to_wire_state_error_v008)
    }

    fn set(
        &mut self,
        key: String,
        value: crate::bindings::v008::youth::state::store::Value,
    ) -> Result<(), crate::bindings::v008::youth::state::store::StateError> {
        self.state
            .set(&key, from_wire_state_value_v008(value))
            .map_err(to_wire_state_error_v008)
    }
    ...
    fn delete(
        &mut self,
        key: String,
    ) -> Result<bool, crate::bindings::v008::youth::state::store::StateError> {
        self.state.delete(&key).map_err(to_wire_state_error_v008)
    }
}

fn to_wire_state_value_v008(
    value: youth_state::StateValue,
) -> crate::bindings::v008::youth::state::store::Value {
    use crate::bindings::v008::youth::state::store::Value;
    match value {
        youth_state::StateValue::Boolean(value) => Value::Boolean(value),
        youth_state::StateValue::Integer(value) => Value::Integer(value),
        youth_state::StateValue::Text(value) => Value::Text(value),
...
fn to_wire_state_error_v008(
    error: youth_state::StateError,
) -> crate::bindings::v008::youth::state::store::StateError {
    use crate::bindings::v008::youth::state::store::ErrorCode;
    let code = match error {
        youth_state::StateError::InvalidKey => ErrorCode::InvalidKey,
        youth_state::StateError::InvalidValue => ErrorCode::InvalidValue,
        youth_state::StateError::ReadOnly => ErrorCode::ReadOnly,
...
impl crate::bindings::v008::youth::editor::session::Host for HostState {
    fn snapshot(
        &mut self,
        editor: u64,
    ) -> Result<
        crate::bindings::v008::youth::editor::session::EditorSnapshot,
        crate::bindings::v008::youth::editor::session::EditorErrorCode,
    > {
        let editor = editor_node_id_v008(editor)?;
        crate::editor_session::snapshot_editor_session(self.editor_sessions_for_call_mut(), editor)
            .map(to_wire_editor_snapshot_v008)
            .map_err(to_wire_editor_error_v008)
    }
    ...
    fn accept(
        ...
        expected_edit_sequence: u64,
        new_document_revision: u64,
    ) -> Result<(), crate::bindings::v008::youth::editor::session::EditorErrorCode> {
        let editor = editor_node_id_v008(editor)?;
        crate::editor_session::accept_editor_session(
            self.staged_editor_sessions_mut(),
            editor,
...
fn editor_node_id_v008(
    value: u64,
) -> Result<youth_tree::NodeId, crate::bindings::v008::youth::editor::session::EditorErrorCode> {
    youth_tree::NodeId::new(value)
        .ok_or(crate::bindings::v008::youth::editor::session::EditorErrorCode::UnknownEditor)
}

fn to_wire_editor_snapshot_v008(
    snapshot: crate::editor_session::EditorSnapshot,
) -> crate::bindings::v008::youth::editor::session::EditorSnapshot {
    crate::bindings::v008::youth::editor::session::EditorSnapshot {
        document_revision: snapshot.document_revision,
...
fn to_wire_editor_error_v008(
    error: crate::editor_session::EditorSessionError,
) -> crate::bindings::v008::youth::editor::session::EditorErrorCode {
    use crate::bindings::v008::youth::editor::session::EditorErrorCode;
    match error {
        crate::editor_session::EditorSessionError::UnknownEditor => EditorErrorCode::UnknownEditor,
        crate::editor_session::EditorSessionError::StaleDocumentRevision => {
            EditorErrorCode::StaleDocumentRevision
...
impl crate::bindings::v008::youth::text_document::document::Host for HostState {
    fn current(
        &mut self,
    ) -> Result<
        crate::bindings::v008::youth::text_document::document::DocumentInfo,
        crate::bindings::v008::youth::text_document::document::ErrorCode,
    > {
        use crate::bindings::v008::youth::text_document::document as wire;
        self.text_document_calls = self
            .text_document_calls
            .checked_add(1)
            .expect("text-document call count exhausted");
        let document = self
            .text_document
            .as_ref()
            .ok_or(wire::ErrorCode::Unavailable)?;
        let info = document.info();
        Ok(wire::DocumentInfo {
            handle: wire::DocumentHandle {
                id: info.handle.id,
                generation: info.handle.generation,
            },
            version: wire::DocumentVersion {
                id: info.version.id,
    ...
    fn request_save(
        &mut self,
        document: crate::bindings::v008::youth::text_document::document::DocumentHandle,
        editor: u64,
    ) -> Result<
        crate::bindings::v008::youth::text_document::document::SaveRequest,
        crate::bindings::v008::youth::text_document::document::ErrorCode,
    > {
        use crate::bindings::v008::youth::text_document::document as wire;
        self.text_document_calls = self
            ...
            .checked_add(1)
            .expect("text-document call count exhausted");
        if self.state.phase() != youth_state::GuestCallPhase::Handle {
            return Err(wire::ErrorCode::WrongPhase);
        }
        if self.staged_save.is_some()
            || self
                .text_document
                .as_ref()
                .is_some_and(crate::text_document::TextDocumentSession::has_pending)
        {
            return Err(wire::ErrorCode::Busy);
        }
        ...
        if info.handle != handle {
            return Err(wire::ErrorCode::InvalidDocument);
        }
        let editor = youth_tree::NodeId::new(editor).ok_or(wire::ErrorCode::InvalidEditor)?;
        let bound = self
            .editor_sessions
            .get(&editor)
            .and_then(crate::editor_session::EditorSessionSlot::text_document_binding);
        if bound != Some(handle) {
            return Err(wire::ErrorCode::InvalidEditor);
        }
        let snapshot = crate::editor_session::snapshot_editor_session(
            self.editor_sessions_for_call_mut(),
            editor,
        )
        .map_err(|_| wire::ErrorCode::InvalidEditor)?;
        let session = self
            .text_document
            .as_ref()
            .ok_or(wire::ErrorCode::Unavailable)?;
        let job = session
            .prepare_save(
                ...
                snapshot.text,
                self.max_editor_bytes,
            )
            .map_err(|error| match error {
                crate::TextDocumentError::TooLarge => wire::ErrorCode::InvalidEditor,
                crate::TextDocumentError::Io(ref source)
                    if source.kind() == std::io::ErrorKind::WouldBlock =>
                {
                    wire::ErrorCode::Busy
                }
                _ => wire::ErrorCode::Internal,
            })?;
        self.external_effect_writes = self
            .external_effect_writes
            .checked_add(1)
            .expect("external-effect write count exhausted");
        let request = job.request;
        self.staged_save = Some(job);
        Ok(wire::SaveRequest {
            id: request.id,
...
impl crate::bindings::v008::youth::time::scheduler::Host for HostState {
    fn schedule_after(
        &mut self,
        millis: u64,
        options: crate::bindings::v008::youth::time::scheduler::ScheduleOptions,
    ) -> Result<
        crate::bindings::v008::youth::time::scheduler::Schedule,
        crate::bindings::v008::youth::time::scheduler::ScheduleErrorCode,
    > {
        let now_epoch_millis = self.deadline_clock.now_epoch_millis();
        let notification = options
            .notification
        ...
        let record = self
            .state
            .schedule_create(now_epoch_millis, millis, notification)
            .map_err(to_wire_schedule_error_v008)?;
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Create {
                app_id: self.state.app_id().clone(),
                record: record.clone(),
        ...
        Ok(to_wire_schedule_v008(&record))
    }

    fn pause(
        &mut self,
        value: crate::bindings::v008::youth::time::scheduler::Schedule,
    ) -> Result<
        crate::bindings::v008::youth::time::scheduler::Schedule,
        crate::bindings::v008::youth::time::scheduler::ScheduleErrorCode,
    > {
        ...
        let previous = self
            ...
            .map_err(to_wire_schedule_error_v008)?
            .ok_or(
                crate::bindings::v008::youth::time::scheduler::ScheduleErrorCode::UnknownSchedule,
            )?;
        let paused = self
            .state
            .schedule_pause(now_epoch_millis, value.id, value.generation)
            .map_err(to_wire_schedule_error_v008)?;
        let wire_paused = to_wire_schedule_v008(&paused);
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Pause {
                app_id: self.state.app_id().clone(),
                previous,
    ...
    > {
        ...
        let resumed = self
            ...
            .schedule_resume(now_epoch_millis, value.id, value.generation)
            .map_err(to_wire_schedule_error_v008)?;
        let wire_resumed = to_wire_schedule_v008(&resumed);
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Resume {
                app_id: self.state.app_id().clone(),
                previous,
    ...
    fn cancel(
        &mut self,
        value: crate::bindings::v008::youth::time::scheduler::Schedule,
    ) -> Result<(), crate::bindings::v008::youth::time::scheduler::ScheduleErrorCode> {
        let previous = self
            .state
            .schedule(value.id)
            .map_err(to_wire_schedule_error_v008)?
        ...
        let cancelled = self
            ...
            .schedule(value.id)
            .map_err(to_wire_schedule_error_v008)?
            .ok_or(crate::bindings::v008::youth::time::scheduler::ScheduleErrorCode::Internal)?;
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Cancel {
                app_id: self.state.app_id().clone(),
                previous,
...
fn to_wire_schedule_error_v008(
    error: youth_state::StateError,
) -> crate::bindings::v008::youth::time::scheduler::ScheduleErrorCode {
    use crate::bindings::v008::youth::time::scheduler::ScheduleErrorCode;
    match error {
        youth_state::StateError::InvalidScheduleDuration => ScheduleErrorCode::InvalidDuration,
        youth_state::StateError::TooManySchedules => ScheduleErrorCode::TooManySchedules,
        youth_state::StateError::UnknownSchedule => ScheduleErrorCode::UnknownSchedule,
...
impl crate::bindings::v009::youth::app::ui::Host for HostState {}

impl crate::bindings::v009::youth::state::store::Host for HostState {
    fn get(
        &mut self,
        key: String,
    ) -> Result<
        Option<crate::bindings::v009::youth::state::store::Value>,
        crate::bindings::v009::youth::state::store::StateError,
    > {
        self.state
            .get(&key)
            .map(|value| value.map(to_wire_state_value_v009))
            .map_err(to_wire_state_error_v009)
    }

    fn set(
        &mut self,
        key: String,
        value: crate::bindings::v009::youth::state::store::Value,
    ) -> Result<(), crate::bindings::v009::youth::state::store::StateError> {
        self.state
            .set(&key, from_wire_state_value_v009(value))
            .map_err(to_wire_state_error_v009)
    }
    ...
    fn delete(
        &mut self,
        key: String,
    ) -> Result<bool, crate::bindings::v009::youth::state::store::StateError> {
        self.state.delete(&key).map_err(to_wire_state_error_v009)
    }
}

fn to_wire_state_value_v009(
    value: youth_state::StateValue,
) -> crate::bindings::v009::youth::state::store::Value {
    use crate::bindings::v009::youth::state::store::Value;
    match value {
        youth_state::StateValue::Boolean(value) => Value::Boolean(value),
        youth_state::StateValue::Integer(value) => Value::Integer(value),
        youth_state::StateValue::Text(value) => Value::Text(value),
...
fn to_wire_state_error_v009(
    error: youth_state::StateError,
) -> crate::bindings::v009::youth::state::store::StateError {
    use crate::bindings::v009::youth::state::store::ErrorCode;
    let code = match error {
        youth_state::StateError::InvalidKey => ErrorCode::InvalidKey,
        youth_state::StateError::InvalidValue => ErrorCode::InvalidValue,
        youth_state::StateError::ReadOnly => ErrorCode::ReadOnly,
...
impl crate::bindings::v009::youth::editor::session::Host for HostState {
    fn snapshot(
        &mut self,
        editor: u64,
    ) -> Result<
        crate::bindings::v009::youth::editor::session::EditorSnapshot,
        crate::bindings::v009::youth::editor::session::EditorErrorCode,
    > {
        let editor = editor_node_id_v009(editor)?;
        crate::editor_session::snapshot_editor_session(self.editor_sessions_for_call_mut(), editor)
            .map(to_wire_editor_snapshot_v009)
            .map_err(to_wire_editor_error_v009)
    }
    ...
    fn accept(
        ...
        expected_edit_sequence: u64,
        new_document_revision: u64,
    ) -> Result<(), crate::bindings::v009::youth::editor::session::EditorErrorCode> {
        let editor = editor_node_id_v009(editor)?;
        crate::editor_session::accept_editor_session(
            self.staged_editor_sessions_mut(),
            editor,
...
fn editor_node_id_v009(
    value: u64,
) -> Result<youth_tree::NodeId, crate::bindings::v009::youth::editor::session::EditorErrorCode> {
    youth_tree::NodeId::new(value)
        .ok_or(crate::bindings::v009::youth::editor::session::EditorErrorCode::UnknownEditor)
}

fn to_wire_editor_snapshot_v009(
    snapshot: crate::editor_session::EditorSnapshot,
) -> crate::bindings::v009::youth::editor::session::EditorSnapshot {
    crate::bindings::v009::youth::editor::session::EditorSnapshot {
        document_revision: snapshot.document_revision,
...
fn to_wire_editor_error_v009(
    error: crate::editor_session::EditorSessionError,
) -> crate::bindings::v009::youth::editor::session::EditorErrorCode {
    use crate::bindings::v009::youth::editor::session::EditorErrorCode;
    match error {
        crate::editor_session::EditorSessionError::UnknownEditor => EditorErrorCode::UnknownEditor,
        crate::editor_session::EditorSessionError::StaleDocumentRevision => {
            EditorErrorCode::StaleDocumentRevision
...
impl crate::bindings::v009::youth::text_document::document::Host for HostState {
    fn current(
        &mut self,
    ) -> Result<
        crate::bindings::v009::youth::text_document::document::DocumentInfo,
        crate::bindings::v009::youth::text_document::document::ErrorCode,
    > {
        use crate::bindings::v009::youth::text_document::document as wire;
        self.text_document_calls = self
            .text_document_calls
            .checked_add(1)
            .expect("text-document call count exhausted");
    ...
    fn request_save(
        &mut self,
        document: crate::bindings::v009::youth::text_document::document::DocumentHandle,
        editor: u64,
    ) -> Result<
        crate::bindings::v009::youth::text_document::document::SaveRequest,
        crate::bindings::v009::youth::text_document::document::ErrorCode,
    > {
        use crate::bindings::v009::youth::text_document::document as wire;
        self.text_document_calls = self
...
impl crate::bindings::v009::youth::time::scheduler::Host for HostState {
    fn schedule_after(
        &mut self,
        millis: u64,
        options: crate::bindings::v009::youth::time::scheduler::ScheduleOptions,
    ) -> Result<
        crate::bindings::v009::youth::time::scheduler::Schedule,
        crate::bindings::v009::youth::time::scheduler::ScheduleErrorCode,
    > {
        let now_epoch_millis = self.deadline_clock.now_epoch_millis();
        let notification = options
            .notification
        ...
        let record = self
            .state
            .schedule_create(now_epoch_millis, millis, notification)
            .map_err(to_wire_schedule_error_v009)?;
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Create {
                app_id: self.state.app_id().clone(),
                record: record.clone(),
        ...
        Ok(to_wire_schedule_v009(&record))
    }

    fn pause(
        &mut self,
        value: crate::bindings::v009::youth::time::scheduler::Schedule,
    ) -> Result<
        crate::bindings::v009::youth::time::scheduler::Schedule,
        crate::bindings::v009::youth::time::scheduler::ScheduleErrorCode,
    > {
        ...
        let previous = self
            ...
            .map_err(to_wire_schedule_error_v009)?
            .ok_or(
                crate::bindings::v009::youth::time::scheduler::ScheduleErrorCode::UnknownSchedule,
            )?;
        let paused = self
            .state
            .schedule_pause(now_epoch_millis, value.id, value.generation)
            .map_err(to_wire_schedule_error_v009)?;
        let wire_paused = to_wire_schedule_v009(&paused);
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Pause {
                app_id: self.state.app_id().clone(),
                previous,
    ...
    > {
        ...
        let resumed = self
            ...
            .schedule_resume(now_epoch_millis, value.id, value.generation)
            .map_err(to_wire_schedule_error_v009)?;
        let wire_resumed = to_wire_schedule_v009(&resumed);
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Resume {
                app_id: self.state.app_id().clone(),
                previous,
    ...
    fn cancel(
        &mut self,
        value: crate::bindings::v009::youth::time::scheduler::Schedule,
    ) -> Result<(), crate::bindings::v009::youth::time::scheduler::ScheduleErrorCode> {
        let previous = self
            .state
            .schedule(value.id)
            .map_err(to_wire_schedule_error_v009)?
        ...
        let cancelled = self
            ...
            .schedule(value.id)
            .map_err(to_wire_schedule_error_v009)?
            .ok_or(crate::bindings::v009::youth::time::scheduler::ScheduleErrorCode::Internal)?;
        self.staged_schedule_outputs.extend(youth_state::transition(
            youth_state::SchedulerInput::Cancel {
                app_id: self.state.app_id().clone(),
                previous,
...
fn to_wire_schedule_error_v009(
    error: youth_state::StateError,
) -> crate::bindings::v009::youth::time::scheduler::ScheduleErrorCode {
    use crate::bindings::v009::youth::time::scheduler::ScheduleErrorCode;
    match error {
        youth_state::StateError::InvalidScheduleDuration => ScheduleErrorCode::InvalidDuration,
        youth_state::StateError::TooManySchedules => ScheduleErrorCode::TooManySchedules,
        youth_state::StateError::UnknownSchedule => ScheduleErrorCode::UnknownSchedule,
...
impl YouthApp {
    ...
    pub fn edit_editor_locally(
        ...
        if let Ok(outcome) = &mut result {
            let dirty_after = crate::editor_session::editor_locally_dirty(
                &self.store.data().editor_sessions,
                editor,
            )
            .unwrap_or(false);
            outcome.locally_dirty = dirty_after;
            outcome.dirty_changed = (dirty_before != Some(dirty_after)).then_some(dirty_after);
        }
    ...
    pub(crate) fn take_committed_save(&mut self) -> Option<crate::text_document::SaveJob> {
        self.store.data_mut().committed_save.take()
    }

    pub(crate) fn deliver_editor_dirty_changed(
        &mut self,
        editor: youth_tree::NodeId,
        dirty: bool,
    ) -> Result<TurnReceipt, RuntimeError> {
        let sequence = self.next_transient_event_sequence()?;
        self.handle_inner(
    ...
    pub(crate) fn accepts_text_document_events(&self) -> bool {
        matches!(
            ...
            ProtocolVersion::V008 | ProtocolVersion::V009
        )
    }
    ...
    pub(crate) fn deliver_save_completion(
        ...
        if let crate::SaveOutcome::Saved {
            document,
            version,
            saved_edit_sequence,
            ref mut still_dirty,
        ...
        {
            *still_dirty = crate::editor_session::accept_saved_text_document(
                &mut self.store.data_mut().editor_sessions,
                completion.editor,
                document,
                saved_edit_sequence,
            ...
            .map_err(|_| {
                RuntimeError::InvalidLifecycle(
                    self.context("saved document no longer matches its Editor session", None),
                )
            })?;
        }
        let sequence = self.next_transient_event_sequence()?;
    ...
    fn next_transient_event_sequence(&mut self) -> Result<u64, RuntimeError> {
        if self.lifecycle != AppLifecycle::Mounted {
            return Err(RuntimeError::InvalidLifecycle(self.context(
                "host event is only valid while the application is mounted",
                None,
            )));
        }
        let sequence = self
    ...
    fn handle_inner(
        ...
        let wire_batch = match guest_result {
            ...
            Err(error) => {
                ...
                let effect_writes = self.store.data().external_effect_writes;
                ...
                self.store.data_mut().discard_staged_save();
        ...
        if let Err(error) = self.validate_text_document_references(&staged_tree, turn_id) {
            return Err(self.rollback_and_fault(error));
        }
        let editor_sessions = crate::editor_session::reconcile_editor_sessions(
            self.store.data().editor_sessions_for_call(),
            &staged_tree,
            self.store.data().text_document.as_ref(),
        );

        let state_writes = self.store.data().state.metrics().writes;
        let external_effect_writes = self.store.data().external_effect_writes;
        ...
        if let Err(error) = self.store.data_mut().commit_staged_save() {
            tracing::error!(%error, "committed text-document save could not be queued");
        }
        self.store
            .data_mut()
    ...
    fn resync_inner(
        ...
        if let Err(error) = self.validate_text_document_references(&tree, turn_id) {
            if install {
                return Err(self.rollback_and_fault(error));
            }
            return Err(error);
    ...
    fn validate_text_document_references(
        &self,
        tree: &youth_tree::Tree,
        turn_id: Option<u64>,
    ) -> Result<(), RuntimeError> {
        let info = self
            ...
            .text_document
            .as_ref()
            .map(crate::text_document::TextDocumentSession::info);
        for node in tree.to_snapshot().nodes {
            let youth_tree::NodeData::TextDocumentEditor {
                document_id,
                document_generation,
                version_id,
                version_generation,
            ...
            let valid = info.as_ref().is_some_and(|info| {
                info.handle.id == document_id
                    && info.handle.generation == document_generation
                    && info.version.id == version_id
                    && info.version.generation == version_generation
            });
            if !valid {
                return Err(RuntimeError::GuestRejected(self.context(
                    "text-document Editor references a stale or forged host token",
                    turn_id,
                )));
            }
        }
    ...
    fn prepare_call(
        ...
        self.store.data_mut().text_document_calls = 0;
        self.store.data_mut().external_effect_writes = 0;
        self.store.data_mut().staged_save = None;
        Ok(())
    }
...
fn instantiate(
    ...
    let text_document = workspace
        .as_ref()
        .map(|grant| {
            crate::text_document::TextDocumentSession::open(grant, limits.tree.max_editor_text_len)
        })
        .transpose()
        .map_err(|source| {
            RuntimeError::StateUnavailable(
                ErrorContext::new(
                    "the granted text document could not be opened",
                    &component_id,
                    AppLifecycle::Loaded,
                    None,
                )
    ...
    let bindings = match protocol {
        ...
        ProtocolVersion::V007 => {
            let mut linker = Linker::<HostState>::new(engine);
            configure_wasi(&mut linker, &component_id)?;
            crate::bindings::v007::Application::add_to_linker::<_, HasSelf<HostState>>(
                &mut linker,
                |state| state,
            )
            .map_err(|source| link_configuration_error(&component_id, source))?;
            let pre = linker
                .instantiate_pre(&component)
                .map_err(|source| link_error(&component_id, source))?;
            let pre = crate::bindings::v007::ApplicationPre::new(pre)
                .map_err(|source| unsupported_world_error(&component_id, protocol, source))?;
            let value = pre
                .instantiate(&mut store)
                .map_err(|source| instantiation_error(&component_id, &store, source))?;
            ApplicationBindings::V007(value)
        }
        ProtocolVersion::V008 => {
            let mut linker = Linker::<HostState>::new(engine);
            configure_wasi(&mut linker, &component_id)?;
            crate::bindings::v008::Application::add_to_linker::<_, HasSelf<HostState>>(
                &mut linker,
                |state| state,
            )
            .map_err(|source| link_configuration_error(&component_id, source))?;
            let pre = linker
                .instantiate_pre(&component)
                .map_err(|source| link_error(&component_id, source))?;
            let pre = crate::bindings::v008::ApplicationPre::new(pre)
                .map_err(|source| unsupported_world_error(&component_id, protocol, source))?;
            let value = pre
                .instantiate(&mut store)
                .map_err(|source| instantiation_error(&component_id, &store, source))?;
            ApplicationBindings::V008(value)
        }
        ProtocolVersion::V009 => {
            let mut linker = Linker::<HostState>::new(engine);
            configure_wasi(&mut linker, &component_id)?;
            crate::bindings::v009::Application::add_to_linker::<_, HasSelf<HostState>>(
                &mut linker,
                |state| state,
            )
            .map_err(|source| link_configuration_error(&component_id, source))?;
            let pre = linker
                .instantiate_pre(&component)
                .map_err(|source| link_error(&component_id, source))?;
            let pre = crate::bindings::v009::ApplicationPre::new(pre)
                .map_err(|source| unsupported_world_error(&component_id, protocol, source))?;
            let value = pre
                .instantiate(&mut store)
                .map_err(|source| instantiation_error(&component_id, &store, source))?;
            ApplicationBindings::V009(value)
        }
    };
    Ok(YouthApp {
        component_id,
...
fn detect_protocol(engine: &Engine, component: &Component) -> Option<ProtocolVersion> {
    ...
    for (name, _) in exports {
        ...
        v007 |= name == "youth:app/lifecycle@0.0.7";
        v008 |= name == "youth:app/lifecycle@0.0.8";
        v009 |= name == "youth:app/lifecycle@0.0.9";
    }
    match (v002, v003, v004, v005, v006, v007, v008, v009) {
        (false, false, false, false, false, false, false, true) => Some(ProtocolVersion::V009),
        (false, false, false, false, false, false, true, false) => Some(ProtocolVersion::V008),
        (false, false, false, false, false, true, false, false) => Some(ProtocolVersion::V007),
        (false, false, false, false, true, false, false, false) => Some(ProtocolVersion::V006),
        (false, false, false, true, false, false, false, false) => Some(ProtocolVersion::V005),
        (false, false, true, false, false, false, false, false) => Some(ProtocolVersion::V004),
        (false, true, false, false, false, false, false, false) => Some(ProtocolVersion::V003),
        (true, false, false, false, false, false, false, false) => Some(ProtocolVersion::V002),
        _ => None,
    }
}
