...
fn v002_v003_and_v004_components_coexist() {
    ...
    // currently targets (0.0.9, since the grow field),
    ...
    assert_eq!(tally.inspect().world, "youth:app/application@0.0.9");
    ...
    assert_eq!(sdk_time.inspect().world, "youth:app/application@0.0.9");
